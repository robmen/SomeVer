...
public static class DefaultPreReleaseIdentifiers
{
    ...
    [Theory]
    [InlineData("1.2.3", "alpha", "1.2.4-alpha.1", 1)]
    [InlineData("1.2.3-rc.1", "alpha", "1.2.3-rc.1.alpha.1", 1)]
    [InlineData("0.0.0", "preview.x", "0.0.1-preview.x.1", 1)]
    [InlineData("0.0.1", "dev", "0.0.2-dev.1", 1)]
    public static async Task AlwaysIncludeDefaultPreRelease(string tag, string identifiers, string expectedVersion, int expectedFullHeight)
    {
        // arrange
